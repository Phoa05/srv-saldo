...
class TransactionEventConsumerTest {
    ...
    void shouldProcessValidMessage() {
        TransactionEventConsumer consumer =
                new TransactionEventConsumer(processTransactionEventUseCase, objectMapper);
        ...
        verify(processTransactionEventUseCase).process(any(TransactionEvent.class));
    }
    ...
    void shouldDiscardMalformedJson() {
        ...
        verify(processTransactionEventUseCase, never()).process(any());
    }
