package br.com.itau.challenge.saldo;
...
class HexagonalArchitectureTest {
	...
	private static final String DOMAIN_PACKAGE = "..saldo.domain..";
	private static final String PORT_PACKAGE = "..saldo.port..";
	private static final String APPLICATION_PACKAGE = "..saldo.application..";
	private static final String ADAPTER_PACKAGE = "..saldo.adapter..";

	private static final JavaClasses CLASSES = new ClassFileImporter()
			.withImportOption(ImportOption.Predefined.DO_NOT_INCLUDE_TESTS)
			.importPackages("br.com.itau.challenge.saldo");
